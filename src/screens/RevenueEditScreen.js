                      ...
                      setRevenueLineAmount(
                         e.target.value
                                       ...
                                       <button
                                          ...
                                          type="submit"
                                          class="w-full text-white bg-blue-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-600"
                                       >
                                          Edit Revenue
                                       </button>
                                    </form>
