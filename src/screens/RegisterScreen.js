...
import { registerTenancy } from '../actions/userActions';
...
const RegisterScreen = () => {
  ...
  const userTenancyRegister = useSelector((state) => state.userTenancyRegister)
  const { loading, error, userInfo } = userTenancyRegister
  ...
  const submitHandler = (e) => {
    ...
    // } else {
    //   dispatch(registerTenancy (ownerEmail,ownerFirstName, ownerLastName,ownerPassword,tenantName,tenantAbout))
    // }
    dispatch(registerTenancy (ownerEmail,ownerFirstName, ownerLastName,ownerPassword,tenantName,tenantAbout))
    navigate(redirect);
  }
...
<h3 class="text-center text-3xl font-semibold -mt-6 mb-4">Register</h3>
                  {/* {loading && <Loader />} */}
          ...
          <div
            ...
            <div class="card flex-shrink-0 w-full  max-w-sm shadow-2xl bg-base-100">
              <div class="card-body">
                ...
                <div class="form-control">
                  <label class="label">
                    <span class="label-text">Organization About</span>
                  </label>
                  <input
                      type="name"
                      id="name"
