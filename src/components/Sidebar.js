...
const Sidebar = () => {
   ...
   return (
      <div>
         {' '}
         <aside class="w-60 md:w-60  " aria-label="Sidebar">
            <div class="overflow-y-auto py-4  dark:bg-gray-800">
               <div class="flex flex-col items-center pb-4">
                  <div class="relative">
                     ...
                     ></img>
                     <span class="top-0 left-16 absolute  w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
                  </div>
